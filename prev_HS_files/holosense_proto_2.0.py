...
import math
import cv2
from Holosense_audio_demo.objloader import *
import time
import Holosense_audio_demo.configdata as configdata
...
def main():
    ...
    object_length_gamespace = 54.90 + 205.06 # size in the game files.
